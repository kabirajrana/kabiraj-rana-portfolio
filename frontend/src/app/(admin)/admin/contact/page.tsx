      ...
      <Card>
        ...
        <CardContent>
          <form action={updateContactPageConfigAction} className="grid gap-2 md:grid-cols-2">
            <input name="email" defaultValue={config?.email ?? ""} placeholder="Public email" className="rounded-xl border border-border bg-surface p-2.5" />
            ...
            <input name="github" defaultValue={String(social.github ?? "")} placeholder="GitHub URL" className="rounded-xl border border-border bg-surface p-2.5" />
            <input name="linkedin" defaultValue={String(social.linkedin ?? "")} placeholder="LinkedIn URL" className="rounded-xl border border-border bg-surface p-2.5" />
