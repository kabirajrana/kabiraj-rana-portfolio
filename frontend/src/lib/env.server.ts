...
const serverEnvSchema = z.object({
  ...
  ADMIN_ALLOW_SEED_LOGIN: z.coerce.boolean().optional(),
...
export const serverEnv = serverEnvSchema.parse({
  ...
  ADMIN_SEED_EMAIL: process.env.ADMIN_SEED_EMAIL ?? process.env.ADMIN_LOGIN_EMAIL,
  ADMIN_SEED_PASSWORD: process.env.ADMIN_SEED_PASSWORD ?? process.env.ADMIN_LOGIN_PASSWORD,
  ADMIN_ALLOW_SEED_LOGIN: process.env.ADMIN_ALLOW_SEED_LOGIN,
