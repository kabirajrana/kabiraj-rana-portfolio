...
export function ContactCtaSection() {
	return (
		<Container className="py-14 md:py-20">
			<FadeIn className="relative overflow-hidden rounded-[2rem] border border-border/65 bg-[radial-gradient(circle_at_50%_0%,hsl(var(--accent)/0.1)_0%,transparent_36%),linear-gradient(150deg,hsl(var(--surface)/0.76)_0%,hsl(var(--background)/0.94)_66%,hsl(var(--background)/0.98)_100%)] px-6 py-16 md:px-10 md:py-20">
				<div
